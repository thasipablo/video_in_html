...
<!-- PROJECT DESCRIPTION -->
# 📖 Video Integration <a name="about-project"></a>

**Video Integration** is a project in witch we show how to embed a youtube video in a html page.
...
```sh
  cd my-folder
  git@github.com:thasipablo/video_integration.git
```
